...
public class MesinHitungTest {
    ...
    public void testPenjumlahan() {
        assertEquals(5.0, Mesin_Hitung.penjumlahan(2.0, 3.0), 0.002);
        assertEquals(-1.0, Mesin_Hitung.penjumlahan(-2.0, 1.0), 0.001);
    }

    @Test
    public void testPengurangan() {
        assertEquals(1.0, Mesin_Hitung.pengurangan(3.0, 2.0), 0.002);
    ...
    public void testPembagian() {
        assertEquals(2.0, Mesin_Hitung.pembagian(6.0, 3.0), 0.002);
